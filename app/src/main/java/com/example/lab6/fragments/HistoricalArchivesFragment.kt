    ...
    companion object {
        ...
        val historicSportEvents = mutableListOf(
            ...
            SportEvent(
                ...
                Date(1968 - 1900, 9, 18) // Year: 1968, Month: October (0-based index), Day: 18
            )
        )
    }
}